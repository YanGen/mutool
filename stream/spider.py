...
def func():
    ...
    for page in range(1,100):
        url = "https://www.c5game.com/csgo/default/result.html?page={}".format(page)
        ...
        for liTag in liTags:
            ...
            num = liTag.find('span',attrs={'class':'num'}).get_text().strip(' on selling').strip('\n').strip()
            ...
            time.sleep(2.5)
        writerToCsv("csgo.csv",totalData)
